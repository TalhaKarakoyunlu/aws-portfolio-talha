...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    summary:
      'A Flutter mobile image editor with Firebase Authentication, 43 built-in filters, and Cutout Pro API integration for AI-powered effects including background removal, color correction, image enhancement, and cartoon selfies.',
    ...
    problem:
      'Build a mobile image editor with full authentication, device gallery and camera integration, a meaningful filter library, and AI-powered special effects — delivered as a group university project in Flutter, a framework the team was learning during development.',
    approach: [
      'Set up Firebase Authentication for the full auth flow: registration with email and password, login with error handling, and logout from the settings drawer.',
      'Integrated Flutter\'s image picker to support both gallery selection and live camera capture as the two entry points into the editing workflow.',
      'Built a filter library of 43 presets, applied in-app with a save flow that writes the edited image back to the device gallery.',
      'Integrated the Cutout Pro API for AI-powered special effects: background removal, face cutout, color correction, image enhancement, and cartoon selfie with 11 style options.',
      'Added a dedicated test screen showing the original and processed image side-by-side, used during development to validate API results before wiring into the main editing flow.',
    ],
    outcome: [
      'Delivered a fully functional Android image editor covering the complete flow: auth, photo selection, editing, and saving back to the device gallery.',
      'Shipped 43 filters and four Cutout Pro API features in the production build: background removal, color correction, image enhancement, and cartoon selfie.',
      'Authentication flow fully functional; language switching in settings was scoped out and noted as a planned addition.',
    ],
    challenges: [
      'Cutout Pro API calls are paid — test usage had to be managed carefully during development to avoid burning credits.',
      'Building stateful editing flows in Flutter (filter selection, API feature results, save confirmation) without a mature state management setup required careful widget composition.',
      'Coordinating gallery picker, camera, and special feature screens as separate navigation destinations while keeping the editing context consistent across them.',
    ],
    gallery: [
      {
        src: '/pixie-welcome.webp',
        alt: 'Pixie welcome screen with Gallery and Camera entry buttons',
        caption: 'Welcome screen — two entry points into the editing flow: Gallery and Camera.',
      },
      {
        src: '/pixie-editing.webp',
        alt: 'Pixie editing page showing Cutout Pro API toolbar at the bottom',
        caption: 'Editing page with the Cutout Pro toolbar: Remove BG, Face Cutout, Correct Color, Make Passport.',
      },
      {
        src: '/pixie-colorizer.webp',
        alt: 'Photo colorizer showing a black and white photo alongside the colorized result',
        caption: 'Photo colorizer: original black-and-white alongside the AI-colorized result.',
      },
      {
        src: '/pixie-gallery.webp',
        alt: 'Pixie gallery picker with directory browser open',
        caption: 'Gallery picker with directory browsing — supports Recent, Images, Drive, and SDCARD sources.',
      },
    ],
    links: [
